...
<div id="sidebar">
    <div id="sidebar-people">
        ...
        <ul>
            ...
            <li>
                <a href="<?php echo htmlspecialchars($person->getFeed(), ENT_QUOTES, 'UTF-8'); ?>" title="<?=_g('Feed')?>"><img src="<?php if ($PlanetConfig->onlyCronDownloads()) { echo 'custom/img/feed.png'; } else { echo 'postload.php?url=' . urlencode(htmlspecialchars($person->getFeed(), ENT_QUOTES, 'UTF-8')); } ?>" alt="<?=_g('Feed')?>" height="12" width="12" /></a>
